app.controller("pluginCtrl",function($scope,siteQuery,domQuery,masonryQuery) {
    var URL = pluginListUrl;
    var formURL = pluginFormUrl;
    var dom = domQuery.getDom("#pluginCtrl"); // 컨트롤러 하부 DOM구조 로딩.
    $scope.tags = _.filter(tagsData,function(tagJson){ return tagJson.type == "plugin";}); // 입력을 위한 태그목록.
