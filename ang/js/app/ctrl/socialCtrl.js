app.controller("socialCtrl",function($scope,siteQuery,domQuery,masonryQuery) {
    var URL = socialListUrl;
    var formURL = socialFormUrl;
    var dom = domQuery.getDom("#socialCtrl"); // 컨트롤러 하부 DOM구조 로딩.
    ...
    // 입력을 위한 태그목록.
    $scope.tags = _.filter(tagsData,function(tagJson){ return tagJson.type == "social";});
    // 업데이트 요청
